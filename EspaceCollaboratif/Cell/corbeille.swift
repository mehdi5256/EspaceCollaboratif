...
//
//        if  (message.text != ""){
//            try! eventBus.send(to: "chat.to.server", body: ["type":"TEXT","address":"chat.to.server","headers":[],"body":message.text!,"file":"","user":fn + " " + ln,"user_img":photoprofil,"room_id":idroom!])
//
//          //vider textfields
//        message.text = ""
//
