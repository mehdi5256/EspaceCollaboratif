...
enum Keys{
   enum MobileIntegrationServer {
     static let baseURL = "http://05bf9bff5084.ngrok.io"
   // static let baseURL = "https://api.jsonbin.io"
    static let baseURLEventBus = "2.tcp.ngrok.io"
      static let basePortEventBus = 15612
    
      static let baseAuthURL =
    "http://7f97907d669f.ngrok.io/auth/realms/espace_collaborative/protocol/openid-connect/auth"
      static let baseTokenURL =
    "http://7f97907d669f.ngrok.io/auth/realms/espace_collaborative/protocol/openid-connect/token"
